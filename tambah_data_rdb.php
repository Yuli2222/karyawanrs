...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO karyawan_klinik_rdb
...
<html>
<head>
    <title>Tambah Data Karyawan Klinik Rambutan Deli Binjai (RDB)</title>
    <style>
...
<body>
    <div class="container">
        <h1>Tambah Data Karyawan Klinik Rambutan Deli Binjai (RDB)</h1>
        <form method="post">
