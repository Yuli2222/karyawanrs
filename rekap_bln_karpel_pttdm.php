...
$query = "SELECT * FROM karyawan_karpel_pttdm
...
if ($export === 'excel') {
    ...
    header("Content-Disposition: attachment; filename=Rekap_Karyawan_Pelaksana_PT_TDM_{$bulan}_{$tahun}.xls");
    echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />";
    echo "<table border='1'>
        <tr><th colspan='15'>Rekap Karyawan Pelaksana PT.TDM - Bulan $bulan Tahun $tahun</th></tr>
        <tr>
          <th>No</th>
          <th>NIK</th>
          <th>Nama</th>
...
<head>
  <meta charset="UTF-8">
  <title>Rekap Bulanan Karyawan Pelaksana PT.TDM</title>
...
<body class="container mt-4">
  <h2>Rekap Bulanan Karyawan Pelaksana PT.TDM</h2>
...
<!-- Tombol kembali -->
  <a href="data_karyawan_karpel.php" class="btn btn-secondary mb-3">
    &larr; Kembali
  </a>
   <!-- Tabel Rekap -->
  <div class="card">
