...
// Ambil data lama
$sql = "SELECT * FROM karyawan_kantor_pttdm WHERE id_pttdm = $id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update = "UPDATE karyawan_kantor_pttdm SET
        nik='$nik',
        nama='$nama',
...
<html>
<head>
    <title>Edit Data Karyawan Kantor Direksi PT.TDM</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Edit Data Karyawan Kantor Direksi PT.TDM</h1>
        <form method="post">
            <?php
        ...
        <a href="data_karyawan_k_pttdm.php" class="back-link">← Kembali ke Daftar Karyawan</a>
    </div>
</body>
</html>