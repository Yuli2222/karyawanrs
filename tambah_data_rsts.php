...
<html>
<head>
    <title>Tambah Data Karyawan Rumah Sakit Tanjung Selamat (RSTS)</title>
    <style>
...
<body>
    <div class="container">
        <h1>Tambah Data Karyawan Rumah Sakit Tanjung Selamat (RSTS)</h1>
        <form method="post">
