...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO karyawan_klinik_bts
...
<html>
<head>
    <title>Tambah Data Karyawan Klinik Pratama Batang Serangan (BTS)</title>
    <style>
...
<body>
    <div class="container">
        <h1>Tambah Data Karyawan Klinik Pratama Batang Serangan (BTS)</h1>
        <form method="post">
