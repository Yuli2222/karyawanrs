...
if (isset($_POST['update_keterangan'])) {
    ...
    $stmt = $conn->prepare("UPDATE absensi_karpim_pttdm SET keterangan=? WHERE id=?");
    ...
    if ($q && $q->num_rows > 0) {
        ...
        $conn->query("UPDATE rekapan_harian_karpim SET keterangan='$ket_esc' 
...
if (isset($_POST['hapus_data'])) {
    ...
    $stmt = $conn->prepare("DELETE FROM absensi_karpim_pttdm WHERE id=?");
...
<head>
    <meta charset="UTF-8">
    <title>Rekapan Absensi Harian Karyawan Pimpinan Kantor Direksi PT.TDM</title>
    <style>
...
<h2>Rekapan Absensi Harian Karyawan Pimpinan Kantor Direksi PT.TDM</h2>
