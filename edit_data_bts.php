...
// Ambil data lama
$sql = "SELECT * FROM karyawan_klinik_bts WHERE id_bts = $id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update = "UPDATE karyawan_klinik_bts SET
        nik='$nik',
        nama='$nama',
...
<html>
<head>
    <title>Edit Data Karyawan Klinik Pratama Batang Serangan (BTS)</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Edit Data Karyawan Klinik Pratama Batang Serangan (BTS)</h1>
        <form method="post">
            <?php
        ...
        <a href="data_karyawan_k_bts.php" class="back-link">← Kembali ke Daftar Karyawan</a>
    </div>
</body>
</html>