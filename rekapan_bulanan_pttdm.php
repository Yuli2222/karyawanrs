...
if (isset($_GET['export']) && $_GET['export'] == 'excel') {
    ...
    header("Content-Disposition: attachment; filename=rekapan_absensi_pttdm_$bulan.xls");
...
<head>
    <meta charset="UTF-8">
    <title>Rekapan Absensi Bulanan Kantor Direksi PT.TDM</title>
    <style>
...
<h2>Rekapan Absensi Bulanan Kantor Direksi PT.TDM</h2>
