...
// Query untuk ambil data absensi bulanan pttdm
$sql = "SELECT 
            nik, 
            nama, 
            jabatan, 
...
if (isset($_GET['export']) && $_GET['export'] == 'excel') {
    ...
    header("Content-Disposition: attachment; filename=rekapan_absensi_rdb_$bulan.xls");

    echo "<table border='1' cellspacing='0' cellpadding='5'>";
    echo "<tr><th colspan='19' style='text-align:center; font-size:16px; background:#f2f2f2;'>Rekapan Absensi Bulanan Klinik Rambutan Deli Binjai - $bulan</th></tr>";
...
<head>
    <meta charset="UTF-8">
    <title>Rekapan Absensi Bulanan Klinik Rambutan Deli Binjai (RDB)</title>
    <style>
...
<h2>Rekapan Absensi Bulanan Klinik Rambutan Deli Binjai (RDB)</h2>
