...
// Ambil data lama
$sql = "SELECT * FROM karyawan_rsts WHERE id_rsts = $id";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $update = "UPDATE karyawan_rsts SET
        nik='$nik',
        nama='$nama',
...
<html>
<head>
    <title>Edit Data Karyawan Rumah Sakit Tanjung Selamat (RSTS)</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Edit Data Karyawan Rumah Sakit Tanjung Selamat (RSTS)</h1>
        <form method="post">
            <?php
        ...
        <a href="data_karyawan_rsts.php" class="back-link">← Kembali ke Daftar Karyawan</a>
    </div>
</body>
</html>
