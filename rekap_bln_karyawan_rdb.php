...
// Ambil filter; pastikan bulan 2 digit
...
$query = "SELECT * FROM karyawan_klinik_rdb 
...
if ($export === 'excel') {
    ...
    header("Content-Disposition: attachment; filename=rekap_karyawan_klinik_Rambutan_Deli_Binjai_RDB_{$bulan}_{$tahun}.xls");
    echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />";
    echo "<table border='1'>
        <tr><th colspan='14'>Rekap Data Karyawan Klinik Rambutan Deli Binjai (RDB) Bulan $bulan Tahun $tahun</th></tr>
        <tr>
...
<head>
    <meta charset="UTF-8">
    <title>Rekap Data Karyawan Bulanan Klinik Rambutan Deli Binjai (RDB)</title>
...
<div class="container py-4">
    <h3 class="mb-4">Rekap Data Karyawan Bulanan Klinik Rambutan Deli Binjai (RDB)</h3>
    ...
    <div class="mb-3 no-print d-flex gap-2">
        ...
        <a href="data_karyawan_k_rdb.php" class="btn btn-secondary">Kembali</a>
        <a href="tambah_data_rdb.php?bulan=<?= $qs_bulan ?>&tahun=<?= $qs_tahun ?>" class="btn btn-primary ms-auto">
    ...
    <table class="table table-bordered table-sm align-middle">
        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $id   = htmlspecialchars($row['id_rdb']);
                ...
                echo "<tr>
                        ...
                        <td class='text-center'>
                            <a href='edit_data_rdb.php?id={$id}&bulan={$qs_bulan}&tahun={$qs_tahun}' class='btn btn-warning btn-sm' title='Edit'>
                                <i class='fas fa-edit'></i>
                            </a>
                            <a href='hapus_data_rdb.php?id={$id}&bulan={$qs_bulan}&tahun={$qs_tahun}' 
