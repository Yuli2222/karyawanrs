...
$query = "SELECT * FROM karyawan_klinik_grd 
...
if ($export === 'excel') {
    ...
    header("Content-Disposition: attachment; filename=rekap_karyawan_klinik_Pratama_garuda_{$bulan}_{$tahun}.xls");
    echo "<meta http-equiv='Content-Type' content='text/html; charset=utf-8' />";
    echo "<table border='1'>
        <tr><th colspan='14'>Rekap Data Karyawan Klinik Pratama Garuda Bulan $bulan Tahun $tahun</th></tr>
        <tr>
...
<head>
    <meta charset="UTF-8">
    <title>Rekap Data Karyawan Bulanan Klinik Pratama Garuda</title>
...
<div class="container py-4">
    <h3 class="mb-4">Rekap Data Karyawan Bulanan Klinik Pratama Garuda</h3>
    ...
    <div class="mb-3 no-print d-flex gap-2">
        ...
        <a href="data_karyawan_k_Garuda.php" class="btn btn-secondary">Kembali</a>
        <!-- Tombol Tambah Karyawan -->
        <a href="tambah_data_garuda.php?bulan=<?= $qs_bulan ?>&tahun=<?= $qs_tahun ?>" class="btn btn-primary ms-auto">
    ...
    <table class="table table-bordered table-sm align-middle">
        ...
        if ($result && $result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                $id   = htmlspecialchars($row['id_klinik_garuda']);
                ...
                echo "<tr>
                        ...
                        <td class='text-center'>
                            <a href='edit_data_garuda.php?id={$id}&bulan={$qs_bulan}&tahun={$qs_tahun}' class='btn btn-warning btn-sm' title='Edit'>
                                <i class='fas fa-edit'></i>
                            </a>
                            <a href='hapus_data_garuda.php?id={$id}&bulan={$qs_bulan}&tahun={$qs_tahun}' 
