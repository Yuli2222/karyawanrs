...
if (isset($_GET['export']) && $_GET['export'] == 'excel') {
    ...
    header("Content-Disposition: attachment; filename=rekapan_absensi_rsts_$bulan.xls");

    echo "<table border='1' cellspacing='0' cellpadding='5'>";
    echo "<tr><th colspan='19' style='text-align:center; font-size:16px; background:#f2f2f2;'>Rekapan Absensi Bulanan Rumah Sakit Tanjung Selamat - $bulan</th></tr>";
...
<head>
    <meta charset="UTF-8">
    <title>Rekapan Absensi Bulanan Rumah Sakit Tanjung Selamat (RSTS)</title>
    <style>
...
<h2>Rekapan Absensi Bulanan Rumah Sakit Tanjung Selamat (RSTS)</h2>
